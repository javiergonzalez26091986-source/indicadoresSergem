...
if st.session_state['pagina_actual'] == 'Inicio':
    ...
    st.markdown("<div style='background-color: #7A7A7A; padding: 15px; border-radius: 8px;'><h3 style='color: #FFFFFF !important; margin:0; font-weight:700;'>Filtros Globales de Control</h3></div><br>", unsafe_allow_html=True)
